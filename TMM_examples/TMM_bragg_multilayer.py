...
wavelengths = L0*np.linspace(0.5,1.6,1000); #500 nm to 1000 nm
...
## run simulation
Ref, Tran = rTMM.run_TMM_simulation(wavelengths, polarization_amplitudes, k_inc, theta, phi, ER, UR, layer_thicknesses,\
